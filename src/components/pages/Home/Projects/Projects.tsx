...
const projectList = [
  {
    title: 'Spotify',
    description:
      "Spotify is music app where you can search for music and add to watchlist and Favorite's. You get the recommendation for the similar musics.",
    homeImg: '/assets/images/spotifyHome.png',
    logoImg: '/assets/images/spotify-logo.png',
  ...
  },
  {
    title: 'Ognomy',
    description:
      'Ognomy is a sleep medicine professionals and is to reduce the number of patients who suffer unnecessarily from a common and curable sleep disorder, sleep apnea. So we can all benefit from the effects of a better night’s sleep.',
    homeImg: '/assets/images/ognomyHome.png',
    logoImg: '/assets/images/ognomy-logo.png',
    live: 'https://ognomy.com/',
    project: '',
    readMore: '',
  },
  {
    title: 'Datatron',
    description:
      'Datatron is an Enterprise AI Platform that Streamlines Machine Learning Operations & Governance Workflows. Built with enterprise scale and security, Datatron MLOps integrates model development seamlessly with your existing CI/CD process. Enabling businesses to deploy models securely and at scale in 90% less time and cost compared to homegrown solutions!',
    homeImg: '/assets/images/datatronHome.png',
    logoImg: '/assets/images/datatron-logo.svg',
    live: 'https://ognomy.com/',
    project: '',
    readMore: '',
  },
    ...
    >
      ...
      <div className="flex flex-col gap-10 py-10 lg:flex-row lg:py-16">
        <div className="w-full">
          ...
          >
            <Image
              src={projectList[currentproject].homeImg}
              alt="HeroImg"
            ...
            <figure className="absolute left-1/2 bottom-16 -translate-x-1/2 rounded-2xl bg-base-100 px-2 py-1 transition-all duration-300 ">
              <div className="relative h-20 w-56">
                <Image
                  src={projectList[currentproject].logoImg}
                  layout="fill"
                  alt="project logo"
                  style={{
        ...
        <div className="relative block w-full py-7 pr-3 pl-10 before:absolute before:left-0 before:-translate-y-full before:text-base before:font-normal before:not-italic before:text-base-200 before:content-['<h3>'] after:absolute after:bottom-0 after:left-0 after:text-base after:font-normal after:not-italic after:text-base-200 after:content-['</h3>'] md:text-4xl md:before:text-lg md:after:text-lg lg:pr-0">
          ...
          <div className="flex flex-wrap gap-4 gap-x-2 text-sm lg:gap-0 lg:text-xl">
            <a
              href={projectList[currentproject].live}
              target="_blank"
            ...
            <a
              ...
              rel="noopener noreferrer"
              className="group pointer-events-none w-max rounded-xl border border-primary py-3 px-5 capitalize hover:cursor-not-allowed hover:bg-primary lg:rounded-none"
              aria-disabled
            >
              <span className="flex items-center justify-center gap-3 text-primary group-hover:text-base-100">
                Project Code
